...
enum net_request_ethernet_cmd {
	...
	NET_REQUEST_ETHERNET_CMD_FLUSH_FDB,
};
...
#define NET_REQUEST_ETHERNET_FLUSH_FDB (NET_ETHERNET_BASE | NET_REQUEST_ETHERNET_CMD_FLUSH_FDB)

NET_MGMT_DEFINE_REQUEST_HANDLER(NET_REQUEST_ETHERNET_FLUSH_FDB);
